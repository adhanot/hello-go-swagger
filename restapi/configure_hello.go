...
import (
	...
	"hello/database"
	"hello/handlers/homehandlers"
	"hello/handlers/usershandlers"
	"hello/pkg/environment"
	"hello/restapi/operations"
)

//go:generate swagger generate server --target ../../hello --name Hello --spec ../gen/api/swagger.yaml --principal interface{}
...
func configureAPI(api *operations.HelloAPI) http.Handler {
	...
	api.HomeGetHelloHandler = homehandlers.NewHomeHandler()
