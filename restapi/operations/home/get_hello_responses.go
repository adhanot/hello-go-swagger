...
type GetHelloOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.WelcomingMessage `json:"body,omitempty"`
}
...
func (o *GetHelloOK) WithPayload(payload *models.WelcomingMessage) *GetHelloOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get hello o k response
func (o *GetHelloOK) SetPayload(payload *models.WelcomingMessage) {
	o.Payload = payload
}
