...
func NewHelloAPI(spec *loads.Document) *HelloAPI {
	return &HelloAPI{
		...
		HomeGetHelloHandler: home.GetHelloHandlerFunc(func(params home.GetHelloParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation home.GetHello has not yet been implemented")
		}),
...
type HelloAPI struct {
	...
	// HomeGetHelloHandler sets the operation handler for the get hello operation
	HomeGetHelloHandler home.GetHelloHandler
...
func (o *HelloAPI) Validate() error {
	...
	if o.HomeGetHelloHandler == nil {
		unregistered = append(unregistered, "home.GetHelloHandler")
	}
...
func (o *HelloAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/hello"] = home.NewGetHello(o.context, o.HomeGetHelloHandler)
