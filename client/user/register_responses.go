...
func (o *RegisterOK) GetPayload() *models.Success {
	return o.Payload
}
...
func (o *RegisterBadRequest) Error() string {
	return fmt.Sprintf("[POST /register][%d] registerBadRequest  %+v", 400, o.Payload)
}
func (o *RegisterBadRequest) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *RegisterInternalServerError) GetPayload() *models.ServerError {
	return o.Payload
}
